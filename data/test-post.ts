...
export const testPosts: Post[] = [
  //text
  {
    ...
    profilePic: mockUsers[0].profile_picture_url,
  ...
  //photo
  {
    ...
    profilePic: mockUsers[1].profile_picture_url,
  ...
  //link
  {
    ...
    profilePic: mockUsers[3].profile_picture_url,
